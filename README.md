...
- [Technial Challenges](#-technical-challenges)
  - [1. 모든 스테이지 공통 기능](#1-모든-스테이지-공통-기능)
    ...
    - [1-3 React에서 DOM 조작과 함께 캔버스를 어떻게 효과적으로 다룰 수 있을까?](#1-3-react-dom-조작과-함께-canvas를-어떻게-효과적으로-다룰-수-있을까)
  - [2. 각 스테이지별 기능](#2-각-스테이지-별-기능)
    - [2-1 물체가 커지고 작아지는 원근법 기능은 어떻게 구현할 수 있을까?](#2-1-물체가-커지고-작아지는-원근법-기능은-어떻게-구현할-수-있을까)
    - [2-2 물체들이 바귀는 착시 기능은 어떻게 구현할 수 있을까?](#2-2-물체들이-바뀌는-착시-기능은-어떻게-구현할-수-있을까)
...
게임 내에서 비주얼 착시라는 독특한 기능은 플레이어가 스테이지2를 클리어하는 데에 핵심적인 역할을 합니다.
...
## 3-1 게임의 스테이지를 추가하거나 다른 기능들을 추가할 수 있게 확장성을 염두에 놓고 작업을 했을까?
...
## 3-2 게임을 플레이 하는 시나리오 외에도 랭킹 등의 기능들을 웹/앱에 어떻게 녹이고, 유저가 게임 흐름을 어떻게 가져가게 할 것 인가?
